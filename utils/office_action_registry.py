...
POWERPOINT_ACTIONS = {
    ...
    "add_speaker_notes": _spec("powerpoint", "add_speaker_notes", (("text",),), {"slide_index": INTISH, "text": TEXT}),
    "append_to_body": _spec("powerpoint", "append_to_body", (("text",),), {"slide_index": INTISH, "text": TEXT}),
    ...
    "set_underline": _spec("powerpoint", "set_underline", (), {"slide_index": INTISH, "underline": BOOLISH}),
    "set_bg_color": _spec("powerpoint", "set_bg_color", (("color",),), {"slide_index": INTISH, "color": TEXT}),
    "set_theme": _spec("powerpoint", "set_theme", (("theme",),), {"slide_index": INTISH, "theme": TEXT}),
    "apply_theme": _spec("powerpoint", "apply_theme", (("theme",),), {"slide_index": INTISH, "theme": TEXT}),
    ...
    "add_image": _spec("powerpoint", "add_image", (("path",),), path_required=True),
    ...
    "add_table": _spec("powerpoint", "add_table", (), {"slide_index": INTISH, "rows": INTISH, "cols": INTISH}),
    "insert_chart": _spec("powerpoint", "insert_chart"),
    "add_chart": _spec("powerpoint", "add_chart"),
    ...
    "find_replace_text": _spec("powerpoint", "find_replace_text", (("find_text",), ("replace_text",))),
    "reorder_slides": _spec("powerpoint", "reorder_slides", (("from_index",), ("to_index",)), {"from_index": INTISH, "to_index": INTISH}),
